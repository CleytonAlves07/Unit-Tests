...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(typeof fecthMenu.value === 'function').toBe(true);
    expect(createMenu()).toContain(fecthMenu);
    expect(createMenu).toHaveProperty('fecthMenu');
    ...
    // ```
    expect(createMenu(fetchMenu)).toContain({ food: {}, drink: {} });
    expect(objetoRetornado.fetchMenu()).toMatchObject({ food: {}, drink: {} });
    expect(objetoRetornado.fetchMenu()).toHaveReturnedWith({ food: {}, drink: {} });
